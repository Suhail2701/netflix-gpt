    ...
    return (
        <div className="min-h-screen bg-cover bg-center bg-no-repeat relative"
            ...
            <div>
                ...
                <div className="absolute w-10/12 xl:w-5/12  2xl:w-3/12 h-[530px] lg:h-[580px] bg-black mx-auto  left-0 right-0 p-1 my-auto lg:my-auto top-0 bottom-0  bg-opacity-70 rounded-lg">

                    <form className=" w-10/12 md:w-8/12 lg:w-8/12 xl:w-10/12 flex flex-col m-auto  lg:p-4 mt-6 text-white " onSubmit={(e) => e.preventDefault()}>
