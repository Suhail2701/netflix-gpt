    ...
    return (
        <div className="bg-black text-white flex flex-col gap-8 py-14">
            <div className="text-center flex flex-col gap-5 w-10/12 mx-auto">
                <h1 className="text-2xl xl:text-3xl font-bold">{movieDetails?.title}</h1>
                <p className="xl:text-lg">{movieDetails?.overview}</p>
            </div>
            <div className="w-10/12 lg:w-3/12 mx-auto text-center  flex flex-col gap-6">
                <h1 className=" text-xl xl:text-2xl font-bold">Movie Details</h1>
                <div className="   flex flex-col justify-center text-left gap-3 mx-auto xl:pl-40 xl:text-lg font-semibold">
